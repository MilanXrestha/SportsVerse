...
public class ValidationUtil {
	...
	// Accepts "male", "female", "other", or "prefer-not-to-say" (case insensitive)
	...
	// 6. Validate if a number is of 10 digits and starts with 97 or 98
	public boolean isValidPhoneNumber(String number) {
	    return !isNullOrEmpty(number) && number.matches("^(97|98)\\d{8}$");
	}
